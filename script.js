...
var lotis = {
  ...
  desc: "When combat begins, the wearer and all allies within 2 hexes in the same row gain a shield that blocks 300 damage for 7 seconds.",
  item1: cv.name,
  item1Img: cv.img,
  item2: rod.name,
  item2Img: rod.img
...
var r = {
  ...
  desc: "When the wearer falls below 25% Health, nearby allies are healed for 1200 Health after a 2.5 second delay. This effect can trigger once per combat.",
  item1: gb.name,
  item1Img: gb.img,
  item2: tear.name,
  item2Img: tear.img
...
var rc = {
  ...
  desc: "When the wearer dies, Repeating Crossbow is re-equipped to a new ally. Each time Repeating Crossbow is re-equipped, it grants additional +20% Attack Speed and +20% Critical Strike Chance for the remainder of combat. This effect can stack any number of times.",
  item1: rec.name,
  item1Img: rec.img,
  item2: sg.name,
  item2Img: sg.img
...
var sos = {
  ...
  desc: "After casting their spell, the wearer's Basic Attacks restore 15% of their Maximum Mana.",
  item1: bf.name,
  item1Img: bf.img,
  item2: tear.name,
  item2Img: tear.img
...
var tc = {
  ...
  desc: "At the beginning of combat, the wearer gains a shield that blocks the first enemy spell that hits them. The enemy that breaks the shield is stunned for 5 seconds.",
  item1: gb.name,
  item1Img: gb.img,
  item2: sg.name,
  item2Img: sg.img
