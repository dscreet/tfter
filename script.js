...
var fh = {
  ...
  desc: "Adjacent enemies lose 25% Attack Speed.",
  item1: cv.name,
  item1Img: cv.img,
  item2: tear.name,
  item2Img: tear.img
...
var ga = {
  ...
  desc: "Wearer revives with 500 Health after a 2 sec delay.",
  item1: bf.name,
  item1Img: bf.img,
  item2: cv.name,
  item2Img: cv.img
...
var grb = {
  ...
  desc: "Attacks grant 5% Attack Speed. Stacks infinitely.",
  item1: rod.name,
  item1Img: rod.img,
  item2: rec.name,
  item2Img: rec.img
...
var h = {
  ...
  desc: "Attacks have a 33% chance on hit to prevent the enemy champion from gaining mana for 4 seconds.",
  item1: nc.name,
  item1Img: nc.img,
  item2: tear.name,
  item2Img: tear.img
...
var ie = {
  ...
  desc: "Critical Strikes deal +200% damage.",
  item1: bf.name,
  item1Img: bf.img,
  item2: bf.name,
  item2Img: bf.img
...
var is = {
  ...
  desc: "Whenever an enemy casts a spell, they take 125 true damage.",
  item1: rod.name,
  item1Img: rod.img,
  item2: nc.name,
  item2Img: nc.img
...
var lotis = {
  ...
  desc: "On start of combat, allies two spaces to the left and right gain a shield of 250 for 6 seconds.",
  item1: rod.name,
  item1Img: rod.img,
  item2: cv.name,
  item2Img: cv.img
...
var m = {
  ...
  desc: "Spells burn for 20% of max HP over 10 seconds and disable healing.",
  item1: rod.name,
  item1Img: rod.img,
  item2: gb.name,
  item2Img: gb.img
...
var red = {
  ...
  desc: "Attacks burn for 20% of max HP over 10s and disable healing.",
  item1: gb.name,
  item1Img: gb.img,
  item2: cv.name,
  item2Img: cv.img
...
var r = {
  ...
  desc: "Upon reaching 25% health, heal all nearby allies for 1500 Health.",
  item1: gb.name,
  item1Img: gb.img,
  item2: tear.name,
  item2Img: tear.img
...
var rh = {
  ...
  stats: "+40 Magic Resist",
  desc: "Summons a spirit who mirrors your attacks, dealing 75% damage. Applies on-hit effects.",
  item1: nc.name,
  item1Img: nc.img,
  item2: spat.name,
  item2Img: spat.img
...
var ss = {
  ...
  desc: "Every 3rd attack deals 100 splash magical damage to 2 additional targets.",
  item1: rec.name,
  item1Img: rec.img,
  item2: tear.name,
  item2Img: tear.img
...
var t = {
  ...
  stats: "+40 Armor",
  desc: "Reflect 100% of mitigated damage taken from attacks as magic damage.",
  item1: cv.name,
  item1Img: cv.img,
  item2: cv.name,
  item2Img: cv.img
